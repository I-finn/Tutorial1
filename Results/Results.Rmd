...
knitr::opts_knit$set(root.dir = "..")   # revert to project working directory
```

## Introduction

How tall are people in the ASDS class and are they normally distributed.
